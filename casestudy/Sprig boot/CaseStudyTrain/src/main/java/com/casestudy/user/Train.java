...
private List<StationStops> stops;
	...
	public Train(long trainNo,
			...
			String destination, @NotNull LocalDate date, LocalTime arrivalTime, LocalTime departureTime, int duration,
			LocalTime destinationTime, List<reservationType> reservationVacancy, List<StationStops> stops) {
		super();
